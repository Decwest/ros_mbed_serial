...
{
    ros::init(argc, argv, "ros_mbed_serial_node");
    ros::NodeHandle n;

    //Publisher
    ros::Publisher serial_pub_f = n.advertise<std_msgs::Float32MultiArray>("Serial_pub_float", 1);
    ros::Publisher serial_pub_i = n.advertise<std_msgs::Int32MultiArray>("Serial_pub_int", 1);
    ros::Publisher serial_pub_c = n.advertise<std_msgs::String>("Serial_pub_string", 1);

    //Subscriber
    ros::Subscriber serial_sub_f = n.subscribe("Serial_sub_float", 1, float_callback);
    ros::Subscriber serial_sub_i = n.subscribe("Serial_sub_int", 1, int_callback);
    ros::Subscriber serial_sub_c = n.subscribe("Serial_sub_string", 1, string_callback);
